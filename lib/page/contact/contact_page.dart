                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: LineContact('Téléphone', '+33 6 82 75 99 26',
                                LineAwesomeIcons.phone_volume_solid,
                                onPressed: launchPhoneCall),
                          ),
                          Padding(
                            padding: EdgeInsets.symmetric(vertical: 24),
                            child: LineContact('Mail', 'info@whiteforest.fr',
                          ...
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                IconButton(
                                  icon: Icon(LineAwesomeIcons.tripadvisor,
                                      size: 32),
